...
import { SelectCountries, Loading } from "../components/index";
import toastOption from "../utils/toastOption";

const TransactionDetails = () => {
  const navigate = useNavigate();

  const { info, setEmail, email, phone , access } = useContext(infoContext);
  ...
  const handleValidation = () => {
    if (!email) {
      ...
      toast.error(
        "You must enter your country suffixes and correct phone number",
        toastOption
      );
      return false;
    } else {
      ...
      >
        ...
        <div className="mt-[50px] w-full flex justify-center items-center font-semibold text-[10px] md:text-xl">
          ...
          <p>
            ...
            <Link
              to="
                  https://www.escrow.com/escrow-101/general-escrow-instructions?amp=true"
            ...
            and
            <Link
              to="https://www.escrow.com/escrow-101/privacy-policy"
              className="capitalize text-blue-700"
            >
              {" "}
              Privacy Policy.
